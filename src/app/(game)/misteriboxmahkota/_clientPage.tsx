...
const MisteriBoxClientPage = ({data}:MBGProps) => {
  ...
  return (
    <div className="flex justify-center items-center h-screen w-screen py-0 lg:py-5 bg-game2 bg-cover">
      ...
      {dialog && <Confetti/>}
      <ScrollArea className="w-full max-h-full h-full bg-black/70 max-w-6xl lg:rounded-md pb-5">
        <div className="flex w-full justify-between p-5">
          <Button size="icon" onClick={handlePlaysound}>
            {muted?<VolumeX/>:<Volume2/>}
          </Button>
          <div className="p-1 ml-10 bg-black/70 rounded-md hidden lg:block">
        ...
        <div className="flex justify-center p-5 mb-5 lg:hidden">
        ...
        <div className="flex mt-5  items-center p-2 px-5 mx-10 rounded-md justify-center bg-white/70 font-medium text-lg text-green-800 space-x-2">
          <HelpCircle/>
          <span>{!isAnimate && isStart?"Silahkan Pilih Hadiah Anda":"Silahkan Masukan MemberID dan Kode voucher"} </span>
        </div>

        <div className="w-full p-5 px-10 grid grid-cols-2 lg:grid-cols-3 items-center justify-center gap-3 lg:gap-10 flex-col dark text-white">
